...
x1_X_x2 = X[:,0]*X[:,1]
x1_X_x2 = np.expand_dims(x1_X_x2, axis=1)
X = np.append(X, x1_X_x2, axis=1)

x1_2 = X[:,0]**2
x1_2 = np.expand_dims(x1_2, axis=1)
X = np.append(X, x1_2, axis=1)

x2_2 = X[:,1]**2
x2_2 = np.expand_dims(x2_2, axis=1)
X = np.append(X, x2_2, axis=1)

x1_X2_2 = (X[:,1]**2)*(X[:,2]**2)
x1_X2_2 = np.expand_dims(x1_X2_2, axis=1)
X = np.append(X, x1_X2_2, axis=1)

x1_3 = X[:,0]**3
x1_3 = np.expand_dims(x1_3, axis=1)
X = np.append(X, x1_3, axis=1)

x2_3 = X[:,1]**3
x2_3 = np.expand_dims(x2_3, axis=1)
X = np.append(X, x2_3, axis=1)
########################################/
